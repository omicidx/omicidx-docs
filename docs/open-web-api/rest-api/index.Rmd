---
title: "Basic web API usage"
linkTitle: "Basic usage"
weight: 10
description: >
  Use the RESTful OmicIDX to access and analyze omics data resources.
---
...
- https://api.omicidx.cancerdatasci.org/sra/experiments?size=0&facets=library_source
- https://api.omicidx.cancerdatasci.org/sra/experiments?size=0&facets=library_strategy&facet_size=30
- https://api.omicidx.cancerdatasci.org/sra/experiments?size=0&facets=sample.taxon_id
- https://api.omicidx.cancerdatasci.org/sra/experiments?size=0&facets=sample.attributes.tag&facet_size=100
- https://api.omicidx.cancerdatasci.org/biosample/samples?size=0&facets=attribute_recs.harmonized_name&facet_size=100
